...
var_i_w, var_s_w, boot_i_w, boot_c_w = naive_bootstrap(300, 1000, xi, yi)

draw_histogram(boot_i_w, 'estimated_intercept', 'wild bootstrap', 'lightskyblue')
draw_histogram(boot_c_w, 'estimated_coef', 'wild bootstrap', 'lightskyblue')